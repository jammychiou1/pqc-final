...
void intt_10_x10(int16_t ntt[9][2][10][8]) {
  ...
  for (int j = 0; j < 9; j++) {

    {
      ...
      for (int i2 = 0; i2 < 2; i2++) {
        ...
        int16x8_t f1_front = vld1q_s16(&ntt[j][0][(5 * i2 + 4) % 10][0]);
        int16x8_t f2_front = vld1q_s16(&ntt[j][0][(5 * i2 + 8) % 10][0]);
        int16x8_t f3_front = vld1q_s16(&ntt[j][0][(5 * i2 + 2) % 10][0]);
        int16x8_t f4_front = vld1q_s16(&ntt[j][0][(5 * i2 + 6) % 10][0]);
...

    {
      ...
      for (int i2 = 0; i2 < 2; i2++) {
        ...
        int16x8_t f1_back = vld1q_s16(&ntt[j][1][(5 * i2 + 4) % 10][0]);
        int16x8_t f2_back = vld1q_s16(&ntt[j][1][(5 * i2 + 8) % 10][0]);
        int16x8_t f3_back = vld1q_s16(&ntt[j][1][(5 * i2 + 2) % 10][0]);
        int16x8_t f4_back = vld1q_s16(&ntt[j][1][(5 * i2 + 6) % 10][0]);
